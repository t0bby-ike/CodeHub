                    ...
                    <ul class="nav-links">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="pages/why-react-is-easy/index.html">Why React Is Easy</a></li>
                                <li><a href="pages/react-future/index.html">React's Future</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="pages/keeping-up-with-changes/index.html">Keeping Up with Changes</a></li>
